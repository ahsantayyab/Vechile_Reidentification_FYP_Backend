...
class ModelConfig:
    model_weights_path: Path | None       # base best_model.pth (fallback)
    plate_weights_path: Path | None       # final_best.pth (plate-fused, preferred)
